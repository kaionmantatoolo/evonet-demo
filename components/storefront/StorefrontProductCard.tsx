        ...
        <Stack spacing={1.25} sx={{ pt: 0.5 }}>
          <Button
            ...
            sx={{
              ...
              bgcolor: "var(--shop-action)",
              color: "var(--shop-action-text)",
              boxShadow: "0 10px 28px color-mix(in srgb, var(--shop-action) 28%, transparent)",
              "&:hover": {
                bgcolor: "var(--shop-action)",
        ...
        <Stack spacing={1} sx={{ pt: 0.5 }}>
          {product.highlights.map((item) => (
            <Typography
              key={item}
              variant="body2"
              sx={{ color: "var(--shop-muted)", display: "flex", gap: 1 }}
            >
              <Box component="span" sx={{ color: "var(--shop-action)", fontWeight: 700 }}>
                ·
              </Box>
              {item}
            </Typography>
